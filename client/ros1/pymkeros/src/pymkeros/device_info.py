...
class DeviceInfo:
	# Constants
	START_SERVICE_PREFIX = "pymkeros1_startpublish_"
	STOP_SERVICE_PREFIX = "pymkeros1_stoppublish_"
	NODE_NAME_PREFIX = "pymkeros1_node_"
	TOPIC_NAME_PREFIX = "/pymkeros1_node_pcd_"
