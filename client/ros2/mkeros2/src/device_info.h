...
class DeviceInfo
{
 private:
  // Constants
  static constexpr const char* START_SERVICE_PREFIX = "mkeros2_startpublish_";
  static constexpr const char* STOP_SERVICE_PREFIX = "mkeros2_stoppublish_";
  static constexpr const char* NODE_NAME_PREFIX = "mkeros2_node_";
  static constexpr const char* TOPIC_NAME_PREFIX = "/mkeros2_node_pcd_";
  static constexpr const char* START_SERVICE_NODE_PREFIX = "mkeros2_start_service_node_pcd_";
  static constexpr const char* STOP_SERVICE_NODE_PREFIX = "mkeros2_stop_service_node_pcd_";
 ...
 public:
  ...
  std::string getStartServiceNodeName() const
  {
    auto name = START_SERVICE_NODE_PREFIX + getName();
    removeSpecialChars(name);
    return name;
  }
  ...
  std::string getStopServiceNodeName() const
  {
    auto name = STOP_SERVICE_NODE_PREFIX + getName();
    removeSpecialChars(name);
    return name;
  }
